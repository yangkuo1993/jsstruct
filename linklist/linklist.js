 ...
 * @LastEditTime: 2021-07-16 11:21:38
 ...
 * @param {ListNode} listnode
 */
LinkList.prototype.insertAfterIndex = function (index, listnode) {
  if (index <= 0) {
...
demo.insertAfterIndex(
  1,
  new ListNode("27", new ListNode("28", new ListNode("29")))
);
